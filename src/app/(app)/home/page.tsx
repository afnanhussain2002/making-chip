...
function Home() {
  ...
  <div className="container mx-auto text-center">
    ...
    <p className="mb-6">Optimize, format, and restore your images using AI with just a few clicks.</p>
...
<section className="py-20 bg-transparent">
  ...
  <div className="p-6 rounded-lg shadow-lg text-center border border-primary">
    ...
    <Scan className='w-16 h-16 mx-auto mb-4'/>
      <h3 className="text-xl font-semibold mb-2">Quality Improve <span className='text-xs bg-primary px-1 rounded'>beta</span></h3>
   ...
   <div className="p-6 rounded-lg shadow-lg text-center border border-primary">
    <RectangleEllipsis className='w-16 h-16 mx-auto mb-4'/>
      <h3 className="text-xl font-semibold mb-2">Fill background <span className='text-xs bg-primary px-1 rounded'>beta</span></h3>
